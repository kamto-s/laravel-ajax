...
(function (root, factory) {
    ...
    $h = {
        ...
        defaults: {
            ...
            tzParts:
                /\b(?:[PMCEA][SDP]T|(?:Australian|Pacific|Mountain|Central|Eastern|Atlantic) (?:Eastern) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
            tzClip: /[^-+\dA-Z]/g,
        },
    ...
    arrayRules: function (element) {
        ...
        $.each(validator.settings.rules, function (name, tmpRules) {
            if (name in cache[element.name]) {
                rules = laravelValidation.helpers.mergeRules(
                    rules,
    ...
    setupValidations: function () {
            ...
            function (value, element, params) {
                ...
                $.each(params, function (i, param) {
                    ...
                    if (
                        ...
                        isArrayRule
                            ? arrayRules.unshift(param)
                            : rules.unshift(param);
                    } else {
                        isArrayRule
                            ? arrayRules.push(param)
                            : rules.push(param);
                    }
                });

                // Validate normal rules.
                var localRulesResult = validateLocalRules(
                    this,
                    [value],
                    element,
                    rules
                ...
                var arrayRulesResult = validateLocalRules(
                    this,
                    arrayValue,
                    element,
                    arrayRules
        ...
        $.validator.addMethod(
            ...
            function (value, element, params) {
                ...
                $.ajax(ajaxOpts(validator, element, params, data)).always(
                ...
                $.ajax(ajaxOpts(validator, element, params, data)).always(
                    function (response, textStatus) {
                        ...
                        if (valid) {
                            ...
                            $.each(
                                response,
                                function (fieldName, errorMessages) {
                                    var errorElement =
                                        laravelValidation.helpers.findByName(
                                            validator,
                                            fieldName
                                        )[0];
                                    if (errorElement) {
                                        errors[errorElement.name] =
                                            laravelValidation.helpers.encode(
                                                errorMessages[0] || ""
                                            );
                                    }
                                }
...
/******/ (function () {
  ...
  \********************************************************/
            /***/ function (module) {
                ...
                function lookupWeekday(dayStr) {
                    ...
                    return (
                        dayNumbers[dayStr.toLowerCase()] || desiredSundayNumber
                    );
                }
                ...
                var formats = {
                    ...
                    timeTiny12: {
                        regex: RegExp(
                            "^" + reHour12 + reSpaceOpt + reMeridian,
                            "i"
                        ),
                        name: "timetiny12",
                    ...
                    iso8601noColon: {
                        regex: RegExp(
                            "^t?" + reHour24lz + reMinutelz + reSecondlz,
                            "i"
                        ),
                        name: "iso8601nocolon",
                        callback: function callback(
                    ...
                    isoWeekDay: {
                        ...
                        callback: function callback(match, year, week, day) {
                            ...
                            dayOfWeek =
                                0 - (dayOfWeek > 4 ? dayOfWeek - 7 : dayOfWeek);
                ...
                module.exports = function strtotime(str, now) {
                    ...
                    while (str.length) {
                        ...
                        for (var i = 0, l = rules.length; i < l; i++) {
                            ...
                            if (match) {
                                if (
                                    !longestMatch ||
                                    match[0].length > longestMatch[0].length
                                ) {
                                    longestMatch = match;
                                    finalRule = format;
                                }
                    ...
                    return Math.floor(
                        result.toDate(new Date(now * 1000)) / 1000
                    );
                };
  ...
  \**************************************************/
            /***/ function (
                ...
                module.exports = function ini_get(varname) {
                    ...
                    if (
                        $locutus.php.ini[varname] &&
                        $locutus.php.ini[varname].local_value !== undefined
                    ) {
            ...
            /***/ function (
                ...
                module.exports = function strlen(string) {
                    ...
                    var iniVal =
                        (true
                            ? __webpack_require__(
                                  /*! ../info/ini_get */ "./node_modules/locutus/php/info/ini_get.js"
                              )("unicode.semantics")
                            : 0) || "off";
                    if (iniVal === "off") {
                        return str.length;
                    ...
                    return (
                        (typeof mixedVar === "number" ||
                            (typeof mixedVar === "string" &&
                                whitespace.indexOf(mixedVar.slice(-1)) ===
                                    -1)) &&
                        mixedVar !== "" &&
                        !isNaN(mixedVar)
                    );
  ...
  \****************************************/
        ...
        /* harmony import */ var locutus_php_strings_strlen__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
                /*! locutus/php/strings/strlen */ "./node_modules/locutus/php/strings/strlen.js"
            );
        /* harmony import */ var locutus_php_strings_strlen__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
                locutus_php_strings_strlen__WEBPACK_IMPORTED_MODULE_0__
            );
        /* harmony import */ var locutus_php_array_array_diff__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
                /*! locutus/php/array/array_diff */ "./node_modules/locutus/php/array/array_diff.js"
            );
        /* harmony import */ var locutus_php_array_array_diff__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
                locutus_php_array_array_diff__WEBPACK_IMPORTED_MODULE_1__
            );
        /* harmony import */ var locutus_php_datetime_strtotime__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
                /*! locutus/php/datetime/strtotime */ "./node_modules/locutus/php/datetime/strtotime.js"
            );
        /* harmony import */ var locutus_php_datetime_strtotime__WEBPACK_IMPORTED_MODULE_2___default =
            /*#__PURE__*/ __webpack_require__.n(
                locutus_php_datetime_strtotime__WEBPACK_IMPORTED_MODULE_2__
            );
        /* harmony import */ var locutus_php_var_is_numeric__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
                /*! locutus/php/var/is_numeric */ "./node_modules/locutus/php/var/is_numeric.js"
            );
        /* harmony import */ var locutus_php_var_is_numeric__WEBPACK_IMPORTED_MODULE_3___default =
            /*#__PURE__*/ __webpack_require__.n(
                locutus_php_var_is_numeric__WEBPACK_IMPORTED_MODULE_3__
            );
        /*!
         * Laravel Javascript Validation
         *
        ...
        $.extend(true, laravelValidation, {
            helpers: {
                ...
                strlen: function (string) {
                    return locutus_php_strings_strlen__WEBPACK_IMPORTED_MODULE_0___default()(
                        string
                    );
                },
                /**
                ...
                getSize: function getSize(obj, element, value) {
                    if (
                        ...
                        return parseFloat(
                            Math.floor(this.fileinfo(element).size)
                        );
                    }
                ...
                parseTime: function (value, format) {
                    ...
                    if (typeof format === "object") {
                        var dateRule = this.getLaravelValidation(
                            "DateFormat",
                            format
                        );
                ...
                compareDates: function (
                    ...
                    if (!timeCompare) {
                        var target = this.dependentElement(
                            validator,
                            element,
                            params
                        );
                ...
                strtotime: function (text, now) {
                    return locutus_php_datetime_strtotime__WEBPACK_IMPORTED_MODULE_2___default()(
                        text,
                        now
                    );
                },
                ...
                is_numeric: function (mixed_var) {
                    return locutus_php_var_is_numeric__WEBPACK_IMPORTED_MODULE_3___default()(
                        mixed_var
                    );
                },
                /**
                ...
                arrayDiff: function (arr1, arr2) {
                    return locutus_php_array_array_diff__WEBPACK_IMPORTED_MODULE_1___default()(
                        arr1,
                        arr2
                    );
                },
                ...
                regexFromWildcard: function (name) {
                    ...
                    return new RegExp(
                        "^" +
                            nameParts
                                .map(function (x) {
                                    return laravelValidation.helpers.escapeRegExp(
                                        x
                                    );
                                })
                                .join("\\[[^\\]]*\\]") +
                ...
                mergeRules: function (rules, newRules) {
                    var rulesList = {
                        ...
                        laravelValidationRemote:
                            newRules.laravelValidationRemote || [],
                    };
...
$.extend(true, laravelValidation, {
    methods: {
        ...
        In: function (value, element, params) {
            if (
                laravelValidation.helpers.isArray(value) &&
        ...
        Before: function (value, element, params) {
            return laravelValidation.helpers.compareDates(
                this,
                value,
                element,
                params[0],
